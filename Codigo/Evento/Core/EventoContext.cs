...
public partial class EventoContext : DbContext
{
    ...
    public virtual DbSet<Tipoinscricaoevento> Tipoinscricaoeventos { get; set; }

    public virtual DbSet<Tipoinscricaosubevento> Tipoinscricaosubeventos { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => new { e.IdPessoa, e.IdEventoEvento }).HasName("PRIMARY");

            entity.ToTable("inscricaopessoaevento");

            entity.HasIndex(e => e.IdEventoEvento, "fk_PessoaEvento_Evento1_idx");

            entity.HasIndex(e => e.IdPapel, "fk_PessoaEvento_Papel1_idx");

            entity.HasIndex(e => e.IdPessoa, "fk_PessoaEvento_Pessoa_idx");

            entity.HasIndex(e => e.IdTipoInscricaoEvento, "fk_PessoaEvento_TipoInscricao1_idx");

            entity.Property(e => e.IdPessoa)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("idPessoa");
            entity.Property(e => e.IdEventoEvento)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("idEventoEvento");
            ...
            entity.Property(e => e.IdTipoInscricaoEvento)
                .HasColumnType("int(11)")
                .HasColumnName("idTipoInscricaoEvento");
            entity.Property(e => e.Status)
            ...
            entity.HasOne(d => d.IdEventoEventoNavigation).WithMany(p => p.Inscricaopessoaeventos)
                .HasForeignKey(d => d.IdEventoEvento)
                .OnDelete(DeleteBehavior.Restrict)
            ...
            entity.HasOne(d => d.IdTipoInscricaoEventoNavigation).WithMany(p => p.Inscricaopessoaeventos)
                .HasForeignKey(d => d.IdTipoInscricaoEvento)
                .OnDelete(DeleteBehavior.Restrict)
        ...
        modelBuilder.Entity<Inscricaopessoasubevento>(entity =>
        {
            ...
            entity.HasIndex(e => e.IdTipoInscricaoSubEvento, "fk_InscricaoPessoaSubEvento_TipoInscricaoSubEvento1_idx");
            ...
            entity.Property(e => e.IdPapel)
                .HasColumnType("int(11)")
                .HasColumnName("idPapel");
            entity.Property(e => e.IdTipoInscricaoSubEvento)
                .HasColumnType("int(11)")
                .HasColumnName("idTipoInscricaoSubEvento");
            entity.Property(e => e.Status)
                .HasDefaultValueSql("'S'")
                .HasComment("A - ATIVA\nC - CANCELADA\nS - SOLICITADA\n")
                .HasColumnType("enum('A','C','S')")
            ...
            entity.HasOne(d => d.IdTipoInscricaoSubEventoNavigation).WithMany(p => p.Inscricaopessoasubeventos)
                .HasForeignKey(d => d.IdTipoInscricaoSubEvento)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("fk_InscricaoPessoaSubEvento_TipoInscricaoSubEvento1");
        });
        ...
        modelBuilder.Entity<Pessoa>(entity =>
        {
            ...
            entity.HasMany(d => d.IdAreaInteresses).WithMany(p => p.IdPessoas)
                .UsingEntity<Dictionary<string, object>>(
                    "Pessoaareainteresse",
                    r => r.HasOne<Areainteresse>().WithMany()
                        .HasForeignKey("IdAreaInteresse")
                        .OnDelete(DeleteBehavior.Restrict)
                    ...
                    j =>
                    {
                        j.HasKey("IdPessoa", "IdAreaInteresse").HasName("PRIMARY");
                        j.ToTable("pessoaareainteresse");
                        j.HasIndex(new[] { "IdAreaInteresse" }, "fk_PessoaAreaInteresse_AreaInteresse1_idx");
                        j.HasIndex(new[] { "IdPessoa" }, "fk_PessoaAreaInteresse_Pessoa1_idx");
                        j.IndexerProperty<uint>("IdPessoa")
                            .HasColumnType("int(10) unsigned")
                            .HasColumnName("idPessoa");
                        j.IndexerProperty<uint>("IdAreaInteresse")
                            .HasColumnType("int(10) unsigned")
        ...
        modelBuilder.Entity<Tipoinscricaoevento>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");

            entity.ToTable("tipoinscricaoevento");
            ...
            entity.HasOne(d => d.IdEventoNavigation).WithMany(p => p.Tipoinscricaoeventos)
                .HasForeignKey(d => d.IdEvento)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("fk_TipoInscricao_Evento1");
        });

        modelBuilder.Entity<Tipoinscricaosubevento>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");

            entity.ToTable("tipoinscricaosubevento");

            entity.HasIndex(e => e.IdSubEvento, "fk_TipoInscricaoSubEvento_SubEvento1_idx");
            ...
            entity.HasOne(d => d.IdSubEventoNavigation).WithMany(p => p.Tipoinscricaosubeventos)
                .HasForeignKey(d => d.IdSubEvento)
                .OnDelete(DeleteBehavior.Restrict)
