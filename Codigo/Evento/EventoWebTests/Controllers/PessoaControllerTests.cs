...
namespace EventoWeb.Controllers.Tests
{
    ...
    public class PessoaControllerTests
    {
        ...
        public void EditTest_Get_Valid()
        {
            ...
            var result = localController.Edit(1, null);
        ...
        public void EditTest_Post_Valid()
        {
            ...
            var result = localController.Edit(model.Id, model, null);
        ...
        {
            var result = controller!.DeleteConfirmed(GetTargetPessoaModel().Id, null);
