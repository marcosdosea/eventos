...
USE evento;
INSERT IGNORE INTO `evento`.`TipoEvento` (`id`, `nome`) VALUES (1, 'Palestra');
INSERT IGNORE INTO `evento`.`TipoEvento` (`id`, `nome`) VALUES (2, 'Mini-curso');
INSERT IGNORE INTO `evento`.`TipoEvento` (`id`, `nome`) VALUES (3, 'Simpósio');
INSERT IGNORE INTO `evento`.`TipoEvento` (`id`, `nome`) VALUES (4, 'Congresso');
INSERT IGNORE INTO `evento`.`TipoEvento` (`id`, `nome`) VALUES (5, 'Workshop');
INSERT IGNORE INTO `evento`.`TipoEvento` (`id`, `nome`) VALUES (6, 'Show');



INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('AC', 'Acre');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('AL', 'Alagoas');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('AP', 'Amapá');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('AM', 'Amazonas');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('BA', 'Bahia');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('CE', 'Ceará');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('ES', 'Espírito Santo');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('GO', 'Goiás');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('MA', 'Maranhão');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('MT', 'Mato Grosso');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('MS', 'Mato Grosso do Sul');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('MG', 'Minas Gerais');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('PA', 'Pará');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('PB', 'Paraíba');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('PR', 'Paraná');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('PE', 'Pernambuco');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('PI', 'Piauí');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('RJ', 'Rio de Janeiro');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('RN', 'Rio Grande do Norte');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('RS', 'Rio Grande do Sul');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('RO', 'Rondônia');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('RR', 'Roraima');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('SC', 'Santa Catarina');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('SP', 'São Paulo');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('SE', 'Sergipe');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('TO', 'Tocantins');
INSERT IGNORE INTO `evento`.`EstadosBrasil` (`estado`, `nome`) VALUES ('DF', 'Distrito Federal');


INSERT IGNORE INTO `evento`.`Papel` (`id`, `nome`) VALUES (1, 'Gestor do Sistema');
INSERT IGNORE INTO `evento`.`Papel` (`id`, `nome`) VALUES (2, 'Gestor do Evento');
INSERT IGNORE INTO `evento`.`Papel` (`id`, `nome`) VALUES (3, 'Colaborador');
INSERT IGNORE INTO `evento`.`Papel` (`id`, `nome`) VALUES (4, 'Participante');

INSERT IGNORE INTO `evento`.`AreaInteresse` (`id`, `nome`) VALUES (1, 'Show Musical');
INSERT IGNORE INTO `evento`.`AreaInteresse` (`id`, `nome`) VALUES (2, 'Tecnologia');
INSERT IGNORE INTO `evento`.`AreaInteresse` (`id`, `nome`) VALUES (3, 'Saúde');
INSERT IGNORE INTO `evento`.`AreaInteresse` (`id`, `nome`) VALUES (4, 'Exposição Cultural');

INSERT IGNORE INTO `evento`.`evento`
...
INSERT IGNORE INTO `evento`.`subevento`
...
INSERT IGNORE INTO `evento`.`tipoinscricao`  (`id`, `idEvento`, `nome`, `descricao`, `valor`, `dataInicio`, `dataFim`, `usadaEvento`, `usadaSubevento`) VALUES 
...
INSERT IGNORE INTO `evento`.`modelocracha`  (`id`, `logotipo`, `texto`, `qrcode`, `idEvento`) VALUES 
...
INSERT IGNORE INTO `evento`.`pessoa` (`id`, `nome`, `nomeCracha`, `cpf`, `sexo`, `cep`, `rua`, `bairro`, `cidade`, `estado`, `numero`, `complemento`, `email`, `telefone1`, `telefone2`, `foto`) VALUES
